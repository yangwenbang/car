...
import com.car.exception.SMSException;
...
public class MoblieMessageUtil {
    ...
    private static final String accessKeyId = "LTAIr38RtWoJdUwN";
    private static final String accessKeySecret = "UgmPNxHxChVL74OLdgE8C2pplBygkD";
...
//                "SMS_112");
    ...
    public static SendSmsResponse sendNewUserNotice(String mobile, String username, String password) throws SMSException {
        try {
    ...
    public static SendSmsResponse sendIdentifyingCode(String mobile, String code) throws SMSException {
        try {
