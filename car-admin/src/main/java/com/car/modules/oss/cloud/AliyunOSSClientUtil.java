...
public class AliyunOSSClientUtil {
     ...
     */
    public static String[] uploadObject2OSS(OSSClient ossClient, byte[] file, String fileName, String bucketName) {
        ...
        try {
            ...
            // 文件名
            String timefile = FORMAT;
            fileName = timefile + StringUtil.getGuid() + fileName.substring(fileName.lastIndexOf("."));
            // 文件大小
            ...
            // 上传文件 (上传文件流的形式)
            PutObjectResult putResult = ossClient.putObject(bucketName, folder + fileName, new ByteArrayInputStream(file),
                    metadata);
            // 解析结果
...
//        String url = t.uploadvideo("C:\\Users\\ailianlu2\\Desktop\\upload\\upload\\1.jpg");
//        System.out.println(url);
        ...
        OSSClient ossClient = AliyunOSSClientUtil.getOSSClient();
        // 上传文件
        String files = "C:\\Users\\ailianlu2\\Desktop\\upload\\upload\\1.jpg";
        String[] file = files.split(",");
        String user_id = "3";
        ...
        for (String filename : file) { //
            File filess = new File(filename);
            String[] s = AliyunOSSClientUtil.uploadObject2OSS(ossClient, filess, BACKET_NAME, user_id);
//            System.out.println("上传后的文件MD5数
            String url = AliyunOSSClientUtil.getUrl(ossClient, BACKET_NAME, s[1]);
            System.out.println("访问网址路径:" + url);
//            byte[] b1 = AliyunOSSClientUtil.image2byte("C:\\Users\\ailianlu2\\Desktop\\upload\\upload\\1.jpg");
//            String str = "";
...
//            url = AliyunOSSClientUtil.getUrl(ossClient, BACKET_NAME, path);
//            System.out.println("访问网址路径:" + url);
        }
